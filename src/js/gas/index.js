...
class App extends Component {
    ...
    changeTime(time){
        ...
        if (time == 'week') {
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetDate/gas.int/" + weekDateString[0] + "/" + weekDateString[6];
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetMonth/gas.int/" + years[0] + "/" + years[years.length -1];
            this.setOption(1, time, sApiUrl, months, years); 
        } 

        else if (time == 'year') {
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetYear/gas.int/";

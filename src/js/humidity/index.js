...
class App extends Component {
    ...
    changeTime(time){
        ...
        if (time == 'week') {
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetDate/Humidity.fixed(1)/" + weekDateString[0] + "/" + weekDateString[6];
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetMonth/Humidity.fixed(1)/" + years[0] + "/" + years[years.length -1];
            this.setOption(1, time, sApiUrl, months, years); 

        } 

        else if (time == 'year') {
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetYear/Humidity.fixed(1)/";
    ...
    getSeriesData(time,json,dataRange) {
        // console.log('json Data:' + time, json.Data);
        // return null;
        let seriesData;
        if (time == 'week') {

...
class App extends Component {
    ...
    changeTime(time){
        ...
        if (time == 'week') {
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetDate/electricity.voltage.a.int/" + weekDateString[0] + "/" + weekDateString[6];
            this.setOption(1, time, sApiUrl, weekday, weekDateString); 
          
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetDate/electricity.voltage.b.int/" + weekDateString[0] + "/" + weekDateString[6];
            this.setOption(2, time, sApiUrl, weekday, weekDateString); 
            
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetDate/electricity.voltage.c.int/" + weekDateString[0] + "/" + weekDateString[6];
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetMonth/electricity.voltage.a.int/" + years[0] + "/" + years[years.length -1];
            this.setOption(1, time, sApiUrl, months, years); 

            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetMonth/electricity.voltage.b.int/" + years[0] + "/" + years[years.length -1];
            this.setOption(2, time, sApiUrl, months, years); 

            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetMonth/electricity.voltage.c.int/" + years[0] + "/" + years[years.length -1];
            this.setOption(3, time, sApiUrl, months, years); 
        } 

        else if (time == 'year') {
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetYear/electricity.voltage.a.int/";
            this.setOption(1, time, sApiUrl);
            
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetYear/electricity.voltage.b.int/";
            this.setOption(2, time, sApiUrl);

            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetYear/electricity.voltage.c.int/";

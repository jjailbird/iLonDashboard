...
class App extends Component {
    ...
    changeTime(time){
        ...
        if (time == 'week') {
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetDate/electricity.power.fixed(2)/" + weekDateString[0] + "/" + weekDateString[6];
            ...
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetMonth/electricity.power.fixed(2)/" + years[0] + "/" + years[years.length -1];
            this.setOption(1, time, sApiUrl, months, years); 
        } 

        else if (time == 'year') {
            sApiUrl = sApiUrlBase + "GetAvgGroupByTargetYear/electricity.power.fixed(2)/";
